#if !defined( LMS_COMMON_DEFS_H_ )
#define LMS_COMMON_DEFS_H_
...
#define MESG_PREFIX_MAXLEN MESG_PREFIX_LEN(MAX_HASH_LEN)
...
#define ITER_MAX_LEN ITER_LEN(MAX_HASH_LEN)
...
#define LEAF_MAX_LEN LEAF_LEN(MAX_HASH_LEN)
...
#define INTR_MAX_LEN INTR_LEN(MAX_HASH_LEN)
...
#define PRG_MAX_LEN PRG_LEN(MAX_HASH_LEN)
